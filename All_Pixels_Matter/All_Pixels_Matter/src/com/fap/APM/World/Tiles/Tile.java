...
public class Tile {
	...
	public static Tile tile_Rock = new Tile(Sprite.tile_Rock12);
	public static Tile tile_Water = new Tile(Sprite.tile_Water12);
	public static Tile tile_Sand = new Tile(Sprite.tile_Sand12);
	public static Tile tile_Floor_Wood = new Tile(Sprite.tile_Floor_Wood12);
	public static Tile tile_Wall_Wood = new Tile(Sprite.tile_Wall_Wood12);
	public static Tile tile_Wall_Rock = new Tile(Sprite.tile_Wall_Rock12);
	public static Tile tile_Floor_Rock = new Tile(Sprite.tile_Floor_Rock12);
	public static Tile tile_Ice = new Tile(Sprite.tile_Ice12);
	public static Tile tile_Snow = new Tile(Sprite.tile_Snow12);
	public static Tile tile_Lava = new Tile(Sprite.tile_Lava12);
	public static Tile tile_Dirt = new Tile(Sprite.tile_Dirt12);
	...
	public void renderTile(int x, int y, ScreenDisplay screen) {
		screen.renderTile(x * screen.getWidthTile(), y * screen.getHeightTile(), this);
