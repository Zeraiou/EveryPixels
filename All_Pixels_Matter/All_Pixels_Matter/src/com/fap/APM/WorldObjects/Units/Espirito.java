...
public class Espirito {
	...
	private AnimatedSprite animationDown = new AnimatedSprite(WorldList.espirito_66_Down, 72, 72, 3);
	private AnimatedSprite animationRight = new AnimatedSprite(WorldList.espirito_66_Right, 72, 72, 3);
	private AnimatedSprite animationUp = new AnimatedSprite(WorldList.espirito_66_Up, 72, 72, 3);
	private AnimatedSprite animationLeft = new AnimatedSprite(WorldList.espirito_66_Left, 72, 72, 3);
	public AnimatedSprite sprite = animationDown;
    public double posX, posY, ticksAlive, movementSpeed;
    public boolean isRemoved = false;
    public boolean isMoving = false;

	public Espirito(int posX, int posY) {
		this.posX = posX;
		this.posY = posY;
